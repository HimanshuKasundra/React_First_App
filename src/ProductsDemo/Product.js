function Product() {
  var Product = [
    {
      ...
      ProductImage: "http://loremflickr.com/640/480/food",
      ProductPrice: "491.00",
      ProductDescription:
  ...
  const formatedProducts = Product.map((prdct) => {
    return (
      <>
        <div class="card col-md-3 my-5 align-center ">
          <img src={prdct.ProductImage} class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">{prdct.ProductName}</h5>
            <p class="card-text">{prdct.ProductDescription}</p>
          </div>
          <ul class="list-group list-group-flush">
            <li class="list-group-item">{prdct.ProductPrice}</li>
            <li class="list-group-item">{prdct.createdAt}</li>
            <li class="list-group-item">{prdct.id}</li>
          </ul>
        </div>
  ...
  return <div class="row">{formatedProducts};</div>;
}
